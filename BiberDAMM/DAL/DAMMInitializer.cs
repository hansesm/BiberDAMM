        ...
        protected override void Seed(ApplicationDbContext _context)
        {
            ...
            var stays = new List<Stay>
            {
                new Stay
                {
                    ...
                    RowVersion = 1,
                    LastUpdated = DateTime.Parse("04.02.2016"),
                    ClientId = 1,
                    ApplicationUserId = 2
                },
                new Stay
                {
                    ...
                    RowVersion = 1,
                    LastUpdated = DateTime.Parse("08.07.2016"),
                    ClientId = 2,
                    ApplicationUserId = 3
                },
                new Stay
